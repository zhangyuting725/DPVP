...
def load_data(config):
    ...
    '''
    #
    train_data = pd.read_csv(config.train_data_path,nrows=100)
    valid_data = pd.read_csv(config.valid_data_path,nrows=100)
    test_data = pd.read_csv(config.test_data_path,nrows=100)
